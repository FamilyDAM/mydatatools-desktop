...
void main() {
  ...
  group('DatabaseRepository', () {
    ...
    test("check all properties are saved", () async {
      m.App app = m.App(
          id: Uuid.v4().toString(), name: "test app #1", slug: "test_app_1", group: "files", order: 1, route: "/app/1");
    ...
    test("Insert multiple Apps", () async {
      m.App app1 = m.App(
          id: Uuid.v4().toString(), name: "test app #1", slug: "test_app_1", group: "files", order: 1, route: "/app/1");
      m.App app2 = m.App(
          id: Uuid.v4().toString(), name: "test app #2", slug: "test_app_2", group: "files", order: 1, route: "/app/2");
      m.App app3 = m.App(
          id: Uuid.v4().toString(), name: "test app #3", slug: "test_app_3", group: "files", order: 1, route: "/app/3");
      var db = databaseRepository.database!;
